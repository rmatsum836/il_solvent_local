...
tf2n.name ='tf2n'
pc = mb.load('mol2/PC.mol2')
pc.name = 'pc'

#fill box with IL's and solvent 
system = mb.fill_box(compound=[bmim, tf2n, pc],
        n_compounds=[200, 200, 822], box = [7, 7, 7])
...
solventPM = opls.apply(solvent, residues = 'pc') # apply forcefields to solvent
...
systemPM.save('IL-pc.gro', overwrite=True)
systemPM.save('IL-pc.top', overwrite=True)
