...
tf2n.name ='tf2n'
bucn = mb.load('mol2/bucn.mol2')
bucn.name = 'bucn'

#fill box with IL's and solvent 
system = mb.fill_box(compound=[bmim, tf2n, bucn],
        n_compounds=[200, 200, 1214], box = [7, 7, 7])
...
solventPM = opls.apply(solvent, residues = 'bucn') # apply forcefields to solvent
...
systemPM.save('IL-bucn.gro', overwrite=True)
systemPM.save('IL-bucn.top', overwrite=True)
