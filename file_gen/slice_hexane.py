...
tf2n.name ='tf2n'
hexane = mb.load('mol2/hexane.mol2')
hexane.name = 'hexane'

#fill box with IL's and solvent 
system = mb.fill_box(compound=[bmim, tf2n, hexane],
        n_compounds=[200, 200, 974], box = [7, 7, 7])
...
solventPM = opls.apply(solvent, residues = 'hexane') # apply forcefields to solvent
...
systemPM.save('IL-hexane.gro', overwrite=True)
systemPM.save('IL-hexane.top', overwrite=True)
